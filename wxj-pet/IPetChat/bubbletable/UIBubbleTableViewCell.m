...
- (void) setupInternalData
{
    ...
    float x = (type == BubbleTypeSomeoneElse) ? 80 : self.frame.size.width - 80 - self.dataInternal.labelSize.width;
    ...
    avatarImage.imageURL = self.dataInternal.data.avatar;
    avatarImage.frame = CGRectMake((type == BubbleTypeSomeoneElse) ? 10 : 270, y - 4, 40, 40);
}
