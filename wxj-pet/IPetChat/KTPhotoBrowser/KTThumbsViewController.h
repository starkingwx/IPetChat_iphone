...
@interface KTThumbsViewController : UIViewController <KTThumbsViewDataSource,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
@private
